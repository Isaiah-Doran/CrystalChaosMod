package net.isaiah.crystalchaos;
...
@Mod(CrystalChaos.MOD_ID)
public class CrystalChaos
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "izayadscrystalchaos";
    ...
    public CrystalChaos(FMLJavaModLoadingContext context)
    {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        ...
        if(event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS){
            ...
            event.accept(ModBlocks.RED_MANA_CRYSTAL_BLOCK);
        }
